...
async function cargarPedidosAdmin() {
    ...
    try {
        const res = await fetch('https://justina-store-backend.onrender.com/api/pedidos');
...
async function actualizarLogistica(idPedido, nuevoPedidoEstado, estadoPagoActual) {
    try {
        const respuesta = await fetch(`https://justina-store-backend.onrender.com/api/pedidos/${idPedido}/estado`, {
            method: 'PUT',
